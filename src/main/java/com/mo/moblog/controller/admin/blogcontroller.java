...
import com.mo.moblog.vo.SearchBlog;
import com.mo.moblog.vo.ShowBlog;
...
public class blogcontroller {
    ...
    public String blogs(Model model, @RequestParam(defaultValue = "1",value = "pageNum") Integer pageNum){
        ...
        List<QueryBlog> list = blogService.getAllBlog();
        PageInfo<QueryBlog> pageInfo = new PageInfo<QueryBlog>(list);
    ...
    public String search(SearchBlog searchBlog, Model model,
        ...
        List<QueryBlog> blogBySearch = blogService.getBlogBySearch(searchBlog);
        PageHelper.startPage(pageNum, 10);
        PageInfo<QueryBlog> pageInfo = new PageInfo<>(blogBySearch);
        model.addAttribute("pageInfo", pageInfo);
